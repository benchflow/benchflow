...
public class MinioTestData {
    ...
    private static final String EXPERIMENT_DEFINITION_FILENAME = "src/test/resources/data/ParallelMultiple11/benchflow-test.yml";
    private static final String DEPLOYMENT_DESCRIPTOR_FILENAME = "src/test/resources/data/ParallelMultiple11/docker-compose.yml";
    private static final String BPM_MODEL_11_PARALLEL_FILENAME = "src/test/resources/data/ParallelMultiple11/models/11ParallelStructured.bpmn";
    private static final String GENERATED_BENCHMARK_FILENAME = "src/test/resources/data/ParallelMultiple11/benchflow-benchmark.jar";
    private static final String FABAN_CONFIGURATION_FILENAME = "src/test/resources/data/ParallelMultiple11/1/run.xml";
