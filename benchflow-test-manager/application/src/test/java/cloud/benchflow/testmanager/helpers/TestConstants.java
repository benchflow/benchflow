...
public class TestConstants {
  ...
  public static final String INVALID_BENCHFLOW_TEST_ID = "benchflow.invalid.0";
  public static final String VALID_BENCHFLOW_TEST_NAME = "testNameExample";
  public static final String VALID_BENCHFLOW_TEST_ID = "benchflow.testNameExample.0";

  public static final String BENCHFLOW_EXPERIMENT_ID = "benchflow.testNameExample.0.0";

  public static String TEST_USER_NAME = "testUser";
  public static User TEST_USER = new User(TEST_USER_NAME);

  public static long VALID_TEST_NUMBER = 0;
  public static long VALID_EXPERIMENT_NUMBER = 0;
