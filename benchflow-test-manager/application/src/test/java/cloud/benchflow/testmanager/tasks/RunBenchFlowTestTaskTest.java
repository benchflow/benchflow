...
public class RunBenchFlowTestTaskTest {
  ...
  private BenchFlowExperimentManagerService peManagerServiceMock =
      Mockito.mock(BenchFlowExperimentManagerService.class);
  ...
  public void setUp() throws Exception {
    ...
    InputStream deploymentDescriptorInputStream =
        BenchFlowTestArchiveExtractor.extractDeploymentDescriptorInputStream(archiveZipInputStream);
  ...
  public void run() throws Exception {
    ...
    verify(minioServiceMock, times(1))
        .saveExperimentDefinition(Mockito.eq(experimentID), Mockito.any(InputStream.class));
