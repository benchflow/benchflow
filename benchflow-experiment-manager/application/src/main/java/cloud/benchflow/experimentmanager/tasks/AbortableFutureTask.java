 ...
 *
 * We do not rely on FutureTask because we need to directly control the state of the task, to be
 * marked as aborted, even when its execution completed because we cancel the task using
