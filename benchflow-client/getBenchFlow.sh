...
#   'wget -qO- https://raw.githubusercontent.com/benchflow/benchflow/devel/getBenchFlow.sh | sh'
#
...
# 		 In case you want to specify a specific version you can use

#			 		$ wget -qO- https://raw.githubusercontent.com/benchflow/benchflow/devel/getBenchFlow.sh | sh -s -- -v <version>
...
do_install() {
	...
	#TODO: handle errors
	$sh_c 'wget -qO- https://raw.githubusercontent.com/benchflow/benchflow/'$VERSION'/benchflow > /usr/local/bin/benchflow' 1>&- 2>&-
