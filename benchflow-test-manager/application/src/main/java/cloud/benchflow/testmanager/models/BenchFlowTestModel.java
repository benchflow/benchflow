...
public class BenchFlowTestModel {
  ...
  public enum TestRunningState {
    DETERMINE_EXPLORATION_STRATEGY, ADD_STORED_KNOWLEDGE, DETERMINE_EXECUTE_VALIDATION_SET, DETERMINE_EXECUTE_EXPERIMENTS, HANDLE_EXPERIMENT_RESULT, VALIDATE_TERMINATION_CRITERIA, DERIVE_PREDICTION_FUNCTION, VALIDATE_PREDICTION_FUNCTION, REMOVE_NON_REACHABLE_EXPERIMENTS, TERMINATING
  }
