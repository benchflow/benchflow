...
public class BenchFlowTestManagerConfiguration extends Configuration {
    ...
    @Valid
    @NotNull
    private ExperimentManagerServiceFactory benchFlowExperimentManagerServiceFactory = new ExperimentManagerServiceFactory();
    ...
    @JsonProperty("benchFlowExperimentManager")
    public void setBenchFlowExperimentManagerServiceFactory(ExperimentManagerServiceFactory benchFlowExperimentManagerServiceFactory) {
